<script setup>
  ...
  function submitRegistrationRequest() {
    ...
    if (submittedFirstName || submittedLastName) {
      ...
      errorMessage.value = 'Please provide at least first name or last name. Waringin: Both fields are required for a successful registration.';
    }
  }
...
<div>
  ...
  <div>
    ...
    <p v-if="errorMessage" class="eror" role="alert">{{errorMessage}}}</p>
  </div>
</div>
</template>
